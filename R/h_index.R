...
#' @param plot Logical value indicating whether to generate and display a plot of the h-index calculation. Set to TRUE or T to generate the plot, and FALSE or F to skip plot generation. The default is set to FALSE.
#'
